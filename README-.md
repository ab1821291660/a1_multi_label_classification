...
#self.soft_label是必选的----adv-软标签ce-focal_loss-label_smoothing##==============================
| BERT+Span+adv
| BERT+Span    | 0.9604(**0.9620**) | 0.9617(0.9632)     | 0.9611(**0.9626**) |
| BERT+Span+ce空dice_loss  
|          +focal_loss    | 0.9516(0.9569) | 0.9644(0.9681)     | 0.9580(0.9625) |
|          +label_smoothing   | 0.9566(0.9568) | 0.9624(0.9656)     | 0.9595(0.9612) |
...
| BERT+Span+ce空dice_loss 
|          +focal_loss    | 0.8121 | 0.8008 | 0.8064 |
|          +label_smoothing   | 0.8235 | 0.7946 | 0.8088 |
### ALBERT for CLUENER
